...
adminCreateRoutes = function (collections) {
    _.each(collections, function (collection, collectionName) {
        adminCreateRouteSchema2(collection, collectionName);
        adminCreateRouteSchema(collection, collectionName);
        adminCreateRouteSchema3(collection, collectionName);
    });
...
adminCreateRouteNew = function (collection, collectionName) {
    return Router.route("adminDashboard" + collectionName + "New", adminCreateRouteNewOptions(collection, collectionName, "/new"));
};
adminCreateRouteSchema = function (collection, collectionName) {
    if (collectionName === "NavTabs")
        return Router.route("adminDashboard" + collectionName + "Schema", adminCreateRouteNewOptions(collection, collectionName, "/nav/collection"));
};
adminCreateRouteSchema2 = function (collection, collectionName) {
    if (collectionName === "NavTabs")
        return Router.route("adminDashboard" + collectionName + "Schema2", adminCreateRouteNewOptions(collection, collectionName, "/title/collection"));
};
adminCreateRouteSchema3 = function (collection, collectionName) {
    if (collectionName === "NavTabs")
        return Router.route("adminDashboard" + collectionName + "Schema3", adminCreateRouteNewOptions(collection, collectionName, "/about/collection"));
};

adminCreateRouteNewOptions = function (collection, collectionName, path) {
    var options, ref;
    options = {
        path: "/admin/" + collectionName + path,
